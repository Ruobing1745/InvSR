...
from sampler_invsr_open import InvSamplerSR
...
def get_parser(**parser_kwargs):
    ...
    # # ===================== 新增 lmd 参数 =====================
    # parser.add_argument(
    #     "--lmd", type=float, default=0.1, help="Closed-loop weight for input adjustment (default: 0.1)"
    # )
    # # ========================================================
...
def get_configs(args):
    ...
    # # ===================== 新增 lmd 配置 =====================
    # configs.lmd = args.lmd  # 把命令行的lmd存入配置
    # # ========================================================
...
def main():
    ...
    # # ===================== 传递 lmd 参数 =====================
    # sampler.inference(args.in_path, out_path=args.out_path, bs=args.bs, lmd=configs.lmd)
    # # ========================================================
